...
.. important::
   ...
   **not be valid if your [abc-7042] container is NOT running**.

.. tip::
   You must have your [abc-7042] container running before connecting to the Visualization and Airflow URLs.
...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/hardikdagar7/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=45759  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='hardikdagar7'  \-\-env DOCKERUSERNAME='hardikdagar0207'  \-\-env MQTTUSERNAME='hardikdagar0207'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
[abc-7042] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/hardikdagar7/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/abc-7042
...
.. important::
   solution_preprocessing_ai_mqtt_dag-abc-7042
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=34139, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=43759, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=37751, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=40645, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=34677, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=46157, HPDEHOST=127.0.1.1, HPDEPORT=35659, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=42315

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-7804-abc-7042,solution_preprocessing_ai_mqtt_dag-abc-7042, python-preprocess-5443-abc-7042,solution_preprocessing_ai_mqtt_dag-abc-7042, python-ai-7757-abc-7042,solution_preprocessing_ai_mqtt_dag-abc-7042, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
